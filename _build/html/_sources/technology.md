...
<figure>
    <iframe width="560" height="315" src="https://www.youtube.com/embed/bDvKnY0g6e4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</figure>
...
```{figure} img/TPACK-new.png
---
align: center
alt: A venn diagram showing the overlapping of the various principles within the T PACK framework.
---
TPACK Overview
Image credit: tpack.org
```

The TPACK Model was developed by Punya Mishra and Matthew J. Koehler. To learn more about the TPACK model, visit [tpack.org](http://tpack.org).
...
<i class="fas fa-repeat" aria-hidden="true"></i>**Substitution**
^^^
...
<i class="fas fa-plus" aria-hidden="true"></i>**Augmentation**
^^^
...
<i class="fas fa-wrench" aria-hidden="true"></i>**Modification**
^^^
...
<i class="fas fa-bot-lightning" aria-hidden="true"></i>**Redefinition**
^^^
...
:::{grid-item-card}
:class-card: sett
<i class="fas fa-school" aria-hidden="true"></i> **Environment**
^^^
...
:::{grid-item-card}
:class-card: sett
<i class="fas fa-list-check" aria-hidden="true"></i> **Tasks**
^^^
...
:::{grid-item-card}
:class-card: sett
<i class="fas fa-toolbox" aria-hidden="true"></i> **Tools**
^^^
